...
const People = () => {
    ...
    return cards.length > 0 ? (
        <div className="h-screen w-full overflow-auto flex flex-col">
            <div className="h-[10vh] z-[10] w-full p-10 flex items-center fixed bg-[#1F1E24] justify-between">
                <div className="flex items-center">
                    <i onClick={() => navigate(-1)} className="ri-arrow-left-line text-2xl"></i>
                    <h1 className="text-2xl ml-3 w-[7vw] leading-none">Person</h1>
                </div>
                <Topnav />
            ...
            <InfiniteScroll
                ...
                next={fetchMoreData}
                hasMore={hasMore}
                className='pt-20 pl-5 w-[100vw] h-screen z-[1]  '
            >
